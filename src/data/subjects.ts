...
export const paper1Subjects: Subject[] = [
  {
    id: 'legal-thought',
    name: '习近平法治思想',
    icon: 'BalanceScale',
...
export const paper2Subjects: Subject[] = [
  {
    id: 'civil-law',
    name: '民法',
    icon: 'Home',
...
export const subjectiveSubjects: Subject[] = [
  paper1Subjects.find(s => s.id === 'legal-thought')!,
  paper1Subjects.find(s => s.id === 'jurisprudence')!,
  paper1Subjects.find(s => s.id === 'constitution')!,
  paper1Subjects.find(s => s.id === 'criminal-law')!,
  paper1Subjects.find(s => s.id === 'criminal-procedure')!,
  paper2Subjects.find(s => s.id === 'civil-law')!,
  paper2Subjects.find(s => s.id === 'commercial-law')!,
  paper2Subjects.find(s => s.id === 'civil-procedure')!,
  paper1Subjects.find(s => s.id === 'administrative-law')!,
  paper1Subjects.find(s => s.id === 'judicial-ethics')!
].filter(Boolean)
